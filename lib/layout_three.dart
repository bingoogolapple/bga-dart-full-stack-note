            ...
            children: [
              Expanded(
                child: Container(
                  ...
                  child: Image.asset('images/container_pic1.jpg'),
                ),
              ),
              Expanded(
                child: Container(
                  ...
                  margin: const EdgeInsets.all(4.0),
                  child: Image.asset('images/container_pic2.jpg'),
                ),
              ),
            ],
          ),
            ...
            children: [
              Expanded(
                child: Container(
                  ...
                  margin: const EdgeInsets.all(4.0),
                  child: Image.asset('images/container_pic3.jpg'),
                ),
              ),
              Expanded(
                child: Container(
                  ...
                  margin: const EdgeInsets.all(4.0),
                  child: Image.asset('images/container_pic4.jpg'),

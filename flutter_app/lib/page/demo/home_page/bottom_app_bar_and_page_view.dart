...
class BottomAppBarAndPageView extends StatefulWidget {
  const BottomAppBarAndPageView({super.key});

  @override
  State<BottomAppBarAndPageView> createState() =>
      _BottomAppBarAndPageViewState();
}

class _BottomAppBarAndPageViewState extends State<BottomAppBarAndPageView>

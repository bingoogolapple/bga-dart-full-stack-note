...
class BottomNavigationBarAndIndexedStack extends StatefulWidget {
  const BottomNavigationBarAndIndexedStack({super.key});

  @override
  State<BottomNavigationBarAndIndexedStack> createState() =>
      _BottomNavigationBarAndIndexedStackState();
}

class _BottomNavigationBarAndIndexedStackState
    extends State<BottomNavigationBarAndIndexedStack>
    with TickerProviderStateMixin {
  static final List<Widget> _pageList = [
    const ChildView(desc: 'IndexedStack one', hasAppBar: true),
    const ChildView(desc: 'IndexedStack two', hasAppBar: true),
    const ChildView(desc: 'IndexedStack three', hasAppBar: true),
    const ChildView(desc: 'IndexedStack four', hasAppBar: true),
  ];

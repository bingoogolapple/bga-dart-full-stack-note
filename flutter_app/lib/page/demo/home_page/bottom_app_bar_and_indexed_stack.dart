...
class BottomAppBarAndIndexedStack extends StatefulWidget {
  const BottomAppBarAndIndexedStack({super.key});

  @override
  State<BottomAppBarAndIndexedStack> createState() =>
      _BottomAppBarAndIndexedStackState();
}

class _BottomAppBarAndIndexedStackState
    extends State<BottomAppBarAndIndexedStack> with TickerProviderStateMixin {
